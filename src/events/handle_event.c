...
static int (*event_functions[sfEvtCount][MAX_EVENT_FUNCTION])(game_t *, sfEvent) = { \
    ...
    {NULL},
    {NULL},
    {event_mouse_button_pressed, event_button_mouse_pressed, NULL},
    {event_mouse_button_released, event_button_mouse_released, NULL},
    {event_mouse_moved, event_button_mouse_moved, NULL},
    {NULL},
    {NULL},
    {NULL},
    {NULL},
